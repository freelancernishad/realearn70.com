<template>
    <div>
        ...
        <section id="account-area">
            <div class="container-fluid">
                ...
                <div class="acc-details"><img :src="$asseturl+'frontend/img/avater.png'">
                    <p class="text-white">{{ row.user.name }} <br>{{ row.plans.name }} <br> Invitation code: {{ row.user.username }}</p>
                </div>
            </div>
        ...
        <section id="btn-area">
            ...
            <div class="row">
                <div class="col-6 p-0"> <router-link :to="{name:'Recharge'}">Deposit</router-link></div>
